        ...
        function responseData(data, start, end) {
            ...
            if (data.issort == false) {
                if (data.events && data.events.length > 0) {
                    events = data.events.sort(function(l, r) { return l[2] > r[2] ? 1 : -1; });//by-weilz 2016-4-29 events = data.sort(function(l, r) { return l[2] > r[2] ? -1 : 1; });
                }
                else {
                    events = [];
                }
...
//                            	直接弹框删除
        ...
        function moreshow(mv) {
            ...
            //此处修改  朱佳佳  2011-08-23 var arrdays = daystr.split('/');	
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.create_event, '" type="button" class="button"/>&nbsp; <SPAN id="bbit-cal-editLink" class="lk">');
                temparr.push( '</SPAN></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
                ...
                calbutton.click(function(e) {
                    ...
                    var zone = new Date().getTimezoneOffset() / 60 * -1;
                    var param = [{ "name": "evtSubject", value: what },
						{ "name": "evtStartTime", value: datestart },
						{ "name": "evtEndTime", value: dateend },
						{ "name": "beAllDay", value: allday },
						{ "name": "timezone", value: zone}];
